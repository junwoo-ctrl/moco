...
def load_pretrained_model_cuda():
...
def torch_inference(*, verbose: bool = True):

    fix_environment()
    moco_v2: nn.Module = load_pretrained_model_cuda()
    sample_image_tensor = get_sample_tensor_data()
